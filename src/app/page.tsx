...
import { resolveScreen } from '@/lib/ui/nav'
...
/**
 * The hub. Since issue #126 the seven old tabs are grouped into three screens —
 * Home (overview + winners), Studio (factories + agents) and Pipeline (review
 * inbox + queue + schedule). Old `?tab=` links still resolve, see resolveScreen.
 */
export default async function Hub({
  ...
  const screen = resolveScreen(tab)
